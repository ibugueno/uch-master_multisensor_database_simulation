...
def v2e_args(parser):
    ...
    cudaGroup = parser.add_argument_group('CUDA / GPU')
    cudaGroup.add_argument(
        "--use_cuda", default=True, type=str2bool,
        help="Use CUDA for acceleration if available (default: True).")
    cudaGroup.add_argument(
        "--gpu_id", type=int, default=0,
        help="GPU ID to use (default: 0). Ignored if --use_cuda is False.")
