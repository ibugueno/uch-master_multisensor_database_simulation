    ...
    with open(csv_log_path, 'w', newline='') as csvfile:
        ...
        for epoch in range(args.epochs):
            ...
            for images, x_px, y_px, z, quat, *_ in tqdm(train_loader, desc=f"Epoch {epoch+1} [Train]"):
                ...
                loss = pos_loss + beta_q_loss * q_loss  # el factor depende de la magnitud; ajusta tras observar entrenamiento
            ...
            total_loss = val_pos_loss + beta_q_loss * val_q_geodesic
