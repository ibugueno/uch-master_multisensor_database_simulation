...
def main():
    ...
    '''
    sensor_frame_ranges = {
        "evk4": {0: (0, 500), 1: (500, 1000), 2: (100,240), 3: (0, 1150)},
        "davis346": {0: (0, 500), 1: (500, 1000), 2: (100,300), 3: (0, 1250)},
        "asus": {0: (0, 500), 1: (500, 1000), 2: (100,260), 3: (0, 1250)},
        "zed2": {0: (0, 500), 1: (0, 1500), 2: (0,400), 3: (500,1500)}
    }
    '''
